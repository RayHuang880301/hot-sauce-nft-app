  ...
  return (
    <div className={styles.section}>
      <div className={styles.container}>
        ...
        <Image src={plutoLogo.src} alt="plutoLogo" width="150px" />
        <span className={styles.des}>With the theme of interactive music NFT, Pluto Lab is committed to developing a community of music lovers in the web3 and NFT world.</span>
